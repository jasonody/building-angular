...
describe('Scope', function () {
	...
	describe('digest', function () {
		...
		it('triggers chained wathers in the same digest', function () {
		...
		it('coalesces many calls to $applyAsync', function (done) {
			...
			scope.$applyAsync(function (scope) { scope.aValue = 'def'; });
		...
		it('allows a $watch to destroy another $watch during digest', function () {
	...
	describe('$watchCollection', function () {
		...
		it('gives the old array value to listener', function () {
	...
	describe('Events', function () {
		...
		fit('attaches targetScope on $emit', function () {
			//targetScope is where the event was emitted from
		...
		fit('attaches targetScope on $broadcast', function () {
			//targetScope is where the event was emitted from
